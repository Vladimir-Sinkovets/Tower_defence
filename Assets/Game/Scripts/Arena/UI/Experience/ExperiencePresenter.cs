...
namespace Assets.Game.Scripts.Arena.UI.Experience
{
    public class ExperiencePresenter : IDisposable
    {
        ...
        public ExperiencePresenter(IExperienceService service, IExperienceView view)
        {
            _service = service;
            _view = view;
        }
        ...
        private void OnExperienceChangedHandler() =>
            _view.SetExperienceBar(_service.Experience / (float)_service.ExperienceForNextLevel);
