...
using Assets.Game.Scripts.Arena.Services.SpawnPointFinders;
...
namespace Assets.Game.Scripts.Arena.Services.EnemySpawners
{
    public class EnemySpawner : IEnemySpawner, IInRoomCallbacks, IDisposable, ITickable
    {
        ...
        public EnemySpawner(IEnemyFactory enemyFactory, EnemySpawnConfig enemySpawnConfig, ISpawnPointFinder spawnPointFinder)
        {
        ...
        private void HandleSpawn()
        {
            ...
            {
                var spawnPoint = _spawnPointFinder.FindSpawnPoint(
                    _enemySpawnConfig.MinSpawnDistance,
                    _enemySpawnConfig.MaxSpawnDistance,
                    _enemySpawnConfig.MinDistanceFromPlayers);
                
                _enemyFactory.Spawn(_enemySpawnConfig.EnemyConfig, spawnPoint);
